...
def main(_):
    ...
    parser.add_argument("--prefix", dest='prefix', type=str, help="model_prefix", default='neg 1 sample increment')
    ...
    with tf.Session(config=config) as sess:
            saver.restore(sess, "./log/TransE_neg 1 sample_49.ckpt")
            iter_offset = 0
            ...
            for n_iter in range(iter_offset,args.max_iter):
                ...
                if n_iter!=0 and (n_iter % args.eval_per == 0 or n_iter == args.max_iter - 1):
                    ...
                    with open("./summary/acc_list_neg1_l2_increment.json", "w") as f:
